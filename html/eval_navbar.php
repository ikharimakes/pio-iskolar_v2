    ...
    <nav class="sidebar">
        ...
        <div class="navBar">
            <ul class="navLinks">
                ...
                <li class="navLink"> <a href="eval_school.php" onclick="activateLink(this)">
                    <span class="icon">
                ...
                <li class="navLink"> <a href="eval_announce.php" onclick="activateLink(this)">
                    <span class="icon">
                ...
                <li class="navLink"> <a href="eval_profile.php" onclick="activateLink(this)">
                    <span class="icon">
                ...
                <!-- <li class="navLink"> <a href="eval_inbox.php" onclick="activateLink(this)">
                    <span class="icon">
